...
function Homepage(prop){
    ...
    return  <nav className="navbar navbar-expand-md " aria-label="Third navbar example">
    <div className=" container container-fluid d-flex flex-wrap py-3 mb-4 ">
      ...
      <button className="navbar-toggler" type="button" onClick={prop.handleClick} data-bs-target="#navbarsExample03" aria-controls="navbarsExample03" aria-expanded="false" aria-label="Toggle navigation">
      ...
      <div className="collapse navbar-collapse" id="navbarsExample03">
        <ul className="navbar-nav ms-auto mb-2">
          ...
          <li className="nav-item">
            <a className="nav-link active text-secondary" aria-current="page" href="/">New</a>
          </li>
          <li className="nav-item">
            <a className="nav-link active text-secondary" aria-current="page" href="/">Popular</a>
          </li>
          <li className="nav-item">
            <a className="nav-link active text-secondary" aria-current="page" href="/">Trending</a>
          </li>
          <li className="nav-item">
            <a className="nav-link active text-secondary" aria-current="page" href="/">Categories</a>
          </li>
        </ul>
      </div>
    </div>
